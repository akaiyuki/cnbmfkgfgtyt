...
public class RDateCheckin implements DatePickerDialog.OnDateSetListener {

    private Calendar calendar;
    private EditText mEditText;
    private Context mContext;

    public RDateCheckin(BaseActivity baseActivity, EditText editText) {
    ...
    public void onDateSet(DatePickerDialog datePickerDialog, int year, int monthOfYear, int dayOfMonth) {
        ...
        RSingleton.setCheckin(mEditText.getText().toString());
